...
class AnomalyCLIPModule(LightningModule):
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        ...
        # 0/0
        image_features, labels, label, segment_size, _ = batch # John
    ...
    def on_validation_epoch_end(self):
        ...
        print(mc_auroc, class_probs.shape, labels.shape, labels[-1000:], normal_idx)
        np.save("GT_classes.npy", labels.cpu().numpy())
        0/0
    ...
    def on_test_start(self):
        ...
        save_dir = Path(os.path.join("/media/pc/MainWork/Codes/AnomalyCLIP/logs/train/runs", str(save_dir)))
